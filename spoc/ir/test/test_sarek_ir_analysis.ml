...
let test_elttype_record_float64 () =
  ...
  let rec_with_f64 = TRecord ("point2d_f64", [("x", TFloat64); ("y", TFloat64)]) in
...
let test_elttype_variant_float64 () =
  let var_no_f64 = TVariant ("option_int", [("None", []); ("Some", [TInt32])]) in
  assert (elttype_uses_float64 var_no_f64 = false);

  let var_with_f64 = TVariant ("number", [("Int", [TInt64]); ("Float", [TFloat64])]) in
...
let test_expr_var_float64 () =
  let v_f64 : var = { var_name = "x"; var_id = 0; var_type = TFloat64; var_mutable = false } in
  let v_f32 : var = { var_name = "y"; var_id = 1; var_type = TFloat32; var_mutable = false } in
...
let test_stmt_assign_float64 () =
  let v : var = { var_name = "x"; var_id = 0; var_type = TFloat32; var_mutable = true } in
  let e_f64 = EConst (CFloat64 1.0) in
  let e_f32 = EConst (CFloat32 1.0) in
...
let test_stmt_for_float64 () =
  let v_f64 : var = { var_name = "i"; var_id = 0; var_type = TFloat64; var_mutable = true } in
  let v_i32 : var = { var_name = "i"; var_id = 0; var_type = TInt32; var_mutable = true } in
...
let test_stmt_let_float64 () =
  let v_f64 : var = { var_name = "x"; var_id = 0; var_type = TFloat64; var_mutable = false } in
  let v_f32 : var = { var_name = "x"; var_id = 0; var_type = TFloat32; var_mutable = false } in
  let e_f32 = EConst (CFloat32 1.0) in
...
let test_decl_local_float64 () =
  let v_f64 : var = { var_name = "x"; var_id = 0; var_type = TFloat64; var_mutable = true } in
  let v_f32 : var = { var_name = "x"; var_id = 0; var_type = TFloat32; var_mutable = true } in
...
let test_helper_uses_float64 () =
  let param_f32 : var = { var_name = "x"; var_id = 0; var_type = TFloat32; var_mutable = false } in
  let param_f64 : var = { var_name = "x"; var_id = 0; var_type = TFloat64; var_mutable = false } in
...
let test_kernel_uses_float64_params () =
  let v_f64 : var = { var_name = "x"; var_id = 0; var_type = TVec TFloat64; var_mutable = false } in
  let v_f32 : var = { var_name = "x"; var_id = 0; var_type = TVec TFloat32; var_mutable = false } in

  let k_f64 : kernel = {
    kern_name = "test";
    kern_params = [DParam (v_f64, Some { arr_elttype = TFloat64; arr_memspace = Global })];
    kern_locals = [];
    kern_body = SEmpty;
    kern_types = [];
    kern_variants = [];
  ...
  let k_f32 : kernel = {
    kern_name = "test";
    kern_params = [DParam (v_f32, Some { arr_elttype = TFloat32; arr_memspace = Global })];
    kern_locals = [];
    kern_body = SEmpty;
    kern_types = [];
    kern_variants = [];
