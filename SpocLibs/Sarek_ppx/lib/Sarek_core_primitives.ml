...
let primitives = [
  ...
  { name = "thread_idx_x"; typ = t_int32;
    variance = ThreadVarying; convergence = NoEffect;
    purity = Pure; category = "thread_id" };
  { name = "thread_idx_y"; typ = t_int32;
    variance = ThreadVarying; convergence = NoEffect;
    purity = Pure; category = "thread_id" };
  { name = "thread_idx_z"; typ = t_int32;
    variance = ThreadVarying; convergence = NoEffect;
    purity = Pure; category = "thread_id" };
  { name = "global_thread_id"; typ = t_int32;
    variance = ThreadVarying; convergence = NoEffect;
    purity = Pure; category = "thread_id" };

  (* === Block Indices (BlockVarying) === *)
  { name = "block_idx_x"; typ = t_int32;
    variance = BlockVarying; convergence = NoEffect;
    purity = Pure; category = "block_id" };
  { name = "block_idx_y"; typ = t_int32;
    variance = BlockVarying; convergence = NoEffect;
    purity = Pure; category = "block_id" };
  { name = "block_idx_z"; typ = t_int32;
    variance = BlockVarying; convergence = NoEffect;
    purity = Pure; category = "block_id" };

  (* === Dimensions (Uniform) === *)
  { name = "block_dim_x"; typ = t_int32;
    variance = Uniform; convergence = NoEffect;
    purity = Pure; category = "dimension" };
  { name = "block_dim_y"; typ = t_int32;
    variance = Uniform; convergence = NoEffect;
    purity = Pure; category = "dimension" };
  { name = "block_dim_z"; typ = t_int32;
    variance = Uniform; convergence = NoEffect;
    purity = Pure; category = "dimension" };
  { name = "grid_dim_x"; typ = t_int32;
    variance = Uniform; convergence = NoEffect;
    purity = Pure; category = "dimension" };
  { name = "grid_dim_y"; typ = t_int32;
    variance = Uniform; convergence = NoEffect;
    purity = Pure; category = "dimension" };
  { name = "grid_dim_z"; typ = t_int32;
    variance = Uniform; convergence = NoEffect;
    purity = Pure; category = "dimension" };

  (* === Synchronization === *)
  { name = "block_barrier"; typ = t_fun [t_unit] t_unit;
    variance = Uniform; convergence = ConvergencePoint;
    purity = Impure; category = "sync" };

  (* === Float32 Math (Pure, Uniform inherent variance) === *)
  { name = "sin"; typ = t_fun [t_float32] t_float32;
    variance = Uniform; convergence = NoEffect;
    purity = Pure; category = "math_f32" };
  { name = "cos"; typ = t_fun [t_float32] t_float32;
    variance = Uniform; convergence = NoEffect;
    purity = Pure; category = "math_f32" };
  { name = "tan"; typ = t_fun [t_float32] t_float32;
    variance = Uniform; convergence = NoEffect;
    purity = Pure; category = "math_f32" };
  { name = "sqrt"; typ = t_fun [t_float32] t_float32;
    variance = Uniform; convergence = NoEffect;
    purity = Pure; category = "math_f32" };
  { name = "rsqrt"; typ = t_fun [t_float32] t_float32;
    variance = Uniform; convergence = NoEffect;
    purity = Pure; category = "math_f32" };
  { name = "exp"; typ = t_fun [t_float32] t_float32;
    variance = Uniform; convergence = NoEffect;
    purity = Pure; category = "math_f32" };
  { name = "log"; typ = t_fun [t_float32] t_float32;
    variance = Uniform; convergence = NoEffect;
    purity = Pure; category = "math_f32" };
  { name = "log2"; typ = t_fun [t_float32] t_float32;
    variance = Uniform; convergence = NoEffect;
    purity = Pure; category = "math_f32" };
  { name = "log10"; typ = t_fun [t_float32] t_float32;
    variance = Uniform; convergence = NoEffect;
    purity = Pure; category = "math_f32" };
  { name = "fabs"; typ = t_fun [t_float32] t_float32;
    variance = Uniform; convergence = NoEffect;
    purity = Pure; category = "math_f32" };
  { name = "floor"; typ = t_fun [t_float32] t_float32;
    variance = Uniform; convergence = NoEffect;
    purity = Pure; category = "math_f32" };
  { name = "ceil"; typ = t_fun [t_float32] t_float32;
    variance = Uniform; convergence = NoEffect;
    purity = Pure; category = "math_f32" };
  { name = "pow"; typ = t_fun [t_float32; t_float32] t_float32;
    variance = Uniform; convergence = NoEffect;
    purity = Pure; category = "math_f32" };
  { name = "fma"; typ = t_fun [t_float32; t_float32; t_float32] t_float32;
    variance = Uniform; convergence = NoEffect;
    purity = Pure; category = "math_f32" };
  { name = "asin"; typ = t_fun [t_float32] t_float32;
    variance = Uniform; convergence = NoEffect;
    purity = Pure; category = "math_f32" };
  { name = "acos"; typ = t_fun [t_float32] t_float32;
    variance = Uniform; convergence = NoEffect;
    purity = Pure; category = "math_f32" };
  { name = "atan"; typ = t_fun [t_float32] t_float32;
    variance = Uniform; convergence = NoEffect;
    purity = Pure; category = "math_f32" };
  { name = "atan2"; typ = t_fun [t_float32; t_float32] t_float32;
    variance = Uniform; convergence = NoEffect;
    purity = Pure; category = "math_f32" };
]
...
let is_thread_varying name =
  ...
  | Some p -> p.variance = ThreadVarying
  | None -> false
...
let pp_primitive fmt p =
  Format.fprintf fmt "@[<v 2>%s:@ type: %a@ variance: %a@ convergence: %a@ purity: %a@ category: %s@]"
    p.name
    Sarek_types.pp_typ p.typ
    pp_variance p.variance
    pp_convergence p.convergence
    pp_purity p.purity
    p.category
