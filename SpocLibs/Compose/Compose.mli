...
class ['a, 'b] class_kernel_max : object
  constraint 'a = float
...
class ['a, 'b] class_dummy_kernel : object
  val binaries : (Spoc.Devices.device, Spoc.Kernel.kernel) Hashtbl.t
...
class type ['a, 'b, 'c] skeleton = object
  ...
  method par_run : Spoc.Devices.device list -> ('f, 'g) Spoc.Vector.vector -> 'c

  method run :
    ?queue_id:int -> Spoc.Devices.device -> ('f, 'g) Spoc.Vector.vector -> 'c
end

class ['a, 'b, 'c] map : ('a, 'b) #Spoc.Kernel.spoc_kernel -> 'c -> 'a -> object
...
val get_vector : ('a, 'b) Spoc.Kernel.kernelArgs -> ('a, 'b) Spoc.Vector.vector
...
val run :
  ...
  ?queue_id:int ->
  Spoc.Devices.device ->
  ('e, 'f) Spoc.Vector.vector ->
  ('c, 'd) Spoc.Vector.vector
...
val pipe :
  ( 'a,
    ('b, 'c) Spoc.Kernel.kernelArgs array,
    ('e, 'f) Spoc.Vector.vector )
  skeleton ->
  ( 'd,
    ('g, 'h) Spoc.Kernel.kernelArgs array,
    ('i, 'j) Spoc.Vector.vector )
  skeleton ->
  ('a, ('b, 'c) Spoc.Kernel.kernelArgs array, ('i, 'j) Spoc.Vector.vector) pipe

val map :
  ('a, ('b, 'c) Spoc.Kernel.kernelArgs array) #Spoc.Kernel.spoc_kernel ->
  ('b, 'c) Spoc.Vector.vector ->
  'a ->
  ('a, ('b, 'c) Spoc.Kernel.kernelArgs array, ('b, 'c) Spoc.Vector.vector) map
