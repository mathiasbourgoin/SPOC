...
RUN rm -rf SPOC && git clone https://github.com/mathiasbourgoin/SPOC.git && chown -R spoc /home/spoc/SPOC
...
RUN eval $(/home/spoc/opam env) && make install install_sarek 

RUN mkdir -p /home/spoc/emacs_install
RUN cp /home/spoc/SPOC/docker_scripts/emacs-pkg-install.el  /home/spoc/emacs_install/emacs-pkg-install.el &&  cp /home/spoc/SPOC/docker_scripts/emacs-pkg-install.sh  /home/spoc/emacs_install/emacs-pkg-install.sh
...
RUN cp  /home/spoc/SPOC/docker_scripts/.emacs /home/spoc/.emacs

USER root
RUN mv /home/spoc/opam /usr/bin/opam
USER spoc
